...
## Next Steps
There are still some errors in code, the remote control does not exactly work consistently with the car's movement, something I need to fix soon. In terms of modifications, I wish to add new wheels that have better traction and look more visually appealing, add a gyroscope to ensure the path direction of the car stays consistently straight, and make the car do a cool trick that will be fun to show during Demo Night! After my modifications and outisde of Bluestamp, I might make additions in the form of making a case for the top of my car to cover the wire work, or including more mini functions for the car to do. 
